...
// 	protoc        (unknown)
// source: servora/sayhello/service/v1/sayhello_doc.proto
...
var File_servora_sayhello_service_v1_sayhello_doc_proto protoreflect.FileDescriptor
...
func init() { file_servora_sayhello_service_v1_sayhello_doc_proto_init() }
func file_servora_sayhello_service_v1_sayhello_doc_proto_init() {
	if File_servora_sayhello_service_v1_sayhello_doc_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_servora_sayhello_service_v1_sayhello_doc_proto_rawDesc), len(file_servora_sayhello_service_v1_sayhello_doc_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_servora_sayhello_service_v1_sayhello_doc_proto_goTypes,
		DependencyIndexes: file_servora_sayhello_service_v1_sayhello_doc_proto_depIdxs,
	}.Build()
	File_servora_sayhello_service_v1_sayhello_doc_proto = out.File
	file_servora_sayhello_service_v1_sayhello_doc_proto_goTypes = nil
	file_servora_sayhello_service_v1_sayhello_doc_proto_depIdxs = nil
}
